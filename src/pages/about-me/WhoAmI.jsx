      ...
      <div className="my-10 flex justify-between flex-col lg:flex-row gap-5">
        ...
        <div className="lg:w-3/4">
          ...
          <p className="mt-5 text-justify">
            Hi, I'm Shahin Islam Arpon, a skilled MERN Stack Web developer. With
            a solid foundation in HTML, CSS, JavaScript, Tailwind and React. I
            have expertise in creating functional and responsive user
